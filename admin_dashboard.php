        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-gradient-blue">
                    ...
                    <div class="stats-link">
                        <a href="member_details.php">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="widget widget-stats bg-gradient-aqua">
                    ...
                    <div class="stats-link">
                        <a href="schedule.php">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-12">
                <div class="widget widget-stats bg-gradient-orange">
                    ...
                    <div class="stats-link">
                        <a href="register.php">View Detail <i class="fa fa-arrow-circle-o-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
