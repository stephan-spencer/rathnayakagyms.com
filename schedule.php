                    ...
                    <div class="panel-body">
                        <table id="data-table" class="table table-striped table-bordered">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>2</td>
                                <td>0771234567</td>
                                <td><select class="default-select2 form-control">
                                        <optgroup label="Male Members">
                                            <option value="AK">John</option>
                                            <option value="HI">Jack</option>
                                        </optgroup>
                                        <optgroup label="Female Members">
                                            <option value="CA">Jane</option>
                                            <option value="NV">Martini</option>
                                        </optgroup>
                                    </select></td>
                            </tr>
